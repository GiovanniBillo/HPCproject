...
echo "Started scalability study for 5-point stencil..."
echo "Running 1st experiment: vary thread number with 1 MPI task. "
...
# echo "Finding best threads-per-task ratio"
